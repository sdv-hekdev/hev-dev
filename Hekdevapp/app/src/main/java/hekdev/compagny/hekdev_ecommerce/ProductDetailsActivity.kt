...
class ProductDetailsActivity : ErrorActivity(), View.OnClickListener {
    ...
    fun getRatingSuccessful(ratingVal: Double) {
        Toast.makeText(this, "ratingVal = $ratingVal", Toast.LENGTH_SHORT).show()
    ...
    private fun rateProduct() {
        ...
        val star = Star(rateVal.toString(), FireStoreClass().getCurrentUserId(), productId)
        ...
        FireStoreClass().checkIfRateExistInStarsThenDo(this, productId, starsId, star, starHashMap)
    }
